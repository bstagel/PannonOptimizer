...
#ifndef PASCALMODELBUILDER_H
#define PASCALMODELBUILDER_H
#include <globals.h>
...
class PascalModelBuilder : public ModelBuilder
{
    friend class PascalModelBuilderTestSuite;
public:
    PascalModelBuilder(unsigned int size = 0);
